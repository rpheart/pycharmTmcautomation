...
Construct_Email_Content
    ...
    Press Key    xpath=//*[@id="editor-headers"]/div[4]/div[2]/input    Auto Test Message Builder    # Coment on Reply to:
...
Verify_Confirmation_Message
    ...
    Select Frame    id=emv-ccmd-iframe    # Click on inner frame
    Sleep    5
    Element Should Contain    xpath=//*[@id="archive-list-container"]/div/div/div/div/div[contains(text(), "QA auto test Message")]    QA auto test Message
    Sleep    5
