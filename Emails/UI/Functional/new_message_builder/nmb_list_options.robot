...
edit_message
  ...
  wait until keyword succeeds  5x  1 sec  element should be visible  ${new_message_builder["button_add"]["add_a_row"]}
...
duplicate_message
  ...
  wait until keyword succeeds  5x  1 sec  element should contain  ${new_message_builder["button_list"]["first_row"]}  COPY
...
convert_to_html_message
  ...
  wait until keyword succeeds  5x  1 sec  element should contain  ${new_message_builder["button_list"]["first_row"]}  HTML
