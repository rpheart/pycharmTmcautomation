*** Settings ***
Documentation       will check the input of each of the blns values into the folders screen
...
folders_name
    ...
    ${is_equal}=    run keyword and return status    should be equal as strings    ${post_test_folder_name}    ${latest_folder_name}
    run keyword unless    ${is_equal}    fail    msg=New folders were created with XSS data
