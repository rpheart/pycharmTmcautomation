...
message_name
    ...
    wait until element is visible     ${classic_message_builder["button_list"]["table"]}     timeout=30
    ${most_recent_classic_message_id}=    get table cell    ${classic_message_builder["button_list"]["table"]}    3    1

    # Check xss data in name field
    loop through test data      ${classic_message_builder["button_add"]["message_name"]}
    ...
    ${is_equal}=    run keyword and return status    should not be equal    ${post_test_classic_message_id}    ${most_recent_classic_message_id}
...
message_description
    ...
    loop through test data      ${classic_message_builder["button_add"]["message_description"]}
...
message_from
    ...
    loop through test data      ${classic_message_builder["button_add"]["message_from"]}
...
message_to
    ...
    loop through test data      ${classic_message_builder["button_add"]["message_to"]}
...
message_subject
    ...
    loop through test data      ${classic_message_builder["button_add"]["message_subject"]}
...
message_reply_to_email_address
    ...
    loop through test data      ${classic_message_builder["button_add"]["message_reply_to_email"]}
...
message_reply_to_label
    ...
    loop through test data      ${classic_message_builder["button_add"]["message_reply_to_label"]}
...
loop through test data
    ...
    \    open content    ${classic_message_builder}    ${classic_message_builder["button_add"]["add"]}
    \    open message header
    \    input text    ${classic_message_builder["button_add"]["message_name"]}    Name        # gets over-written if the field being tested is name itself!!
    \    input text    ${classic_message_builder["button_add"]["message_reply_to_email"]}    test@robot.com        # gets over-written if the field being tested is body itself!!
...
open message header
    ...
    ...    AND    Wait Until element Is Visible    ${classic_message_builder["button_add"]["header_accordion"]}    timeout=30
    click element    ${classic_message_builder["button_add"]["header_accordion"]}
    Wait Until element Is Visible    ${classic_message_builder["button_add"]["message_name"]}    timeout=30