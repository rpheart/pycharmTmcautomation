...
*** Test Cases ***
Create Transactional Content Block Name
    ...
    \    Input Text    ${transactional_content_block["button_add"]["customer_name"]}    ${line}
    \    Input Text    ${transactional_content_block["button_add"]["customer_description"]}    test
