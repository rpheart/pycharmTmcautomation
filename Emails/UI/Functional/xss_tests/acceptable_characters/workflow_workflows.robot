*** Settings ***
Documentation       will check the input of unicode values into the workflow workflows screen
...
workflow_name
    ...
    ${is_equal}=    run keyword and return status    should not be equal as strings    ${post_test_workflow_id}    ${most_recent_workflow_id}
    run keyword unless    ${is_equal}    fail    msg=No new workflows were created with non-XSS data
