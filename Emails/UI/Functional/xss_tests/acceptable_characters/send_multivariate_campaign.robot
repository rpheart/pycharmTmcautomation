*** Settings ***
Documentation       will check the input of unicode values into the MultiVariate screen
...
multivariate_campaign_name
    ...
    run keyword unless    ${is_equal}    fail    msg=No new MultiVariate Message Campaigns were created with non-XSS data
...
multivariate_campaign_search
    verify non xss data on search field    ${multivariate_campaign}    ${multivariate_campaign["button_list"]["list"]}
