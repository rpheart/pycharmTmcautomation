*** Settings ***
Documentation       will check the input of unicode values into the transactional content block screen
Resource            ../../../Utils/keywords.robot
Resource            ../../../Utils/xss_keywords.robot
Default Tags        email    ui    non_xss
...
transactional_content_block_name
    ...
    ${is_equal}=    run keyword and return status    should not be equal as integers    ${post_test_content_block_id}    ${most_recent_content_block_id}
