*** Settings ***
Documentation       will check the input of unicode values into the create new message builder search screen
...
*** Test Cases ***
new_message_search
    verify non xss data on search field    ${new_message_builder}    ${new_message_builder["button_list"]["list"]}
...
new_message_rename_name
    ...
    run keyword if    ${is_failed}    fail    msg=No new Messages were created with non-XSS data
