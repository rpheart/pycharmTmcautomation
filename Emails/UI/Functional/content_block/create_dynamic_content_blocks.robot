...
Test Teardown   delete latest content block
...
create_dynamic_content_block
  ...
  wait until keyword succeeds  5x  1 sec  element should contain  ${content_block["button_list"]["first_row"]}  QA Auto Content Block
