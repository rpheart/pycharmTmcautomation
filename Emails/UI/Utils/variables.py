...
generics = {
    ...
    "content_upload":
    {
        "link": "xpath=//*[@id='iconToolboxContentUpload']/../../a/div[contains(text(), 'Content Upload') or ./text() = 'Content Upload']",
        "popup_url_input": "name=uploadUrl",
        "popup_file_btn": "xpath=//a[contains(text(),'Upload')]",
    },
    "link_management":
    {
        "link": "xpath=//*[@id='iconToolboxLinksManagt']/../../a/div[contains(text(), 'Link Management') or ./text() = 'Link Management']",
        ...
        "save_link": "xpath=//a[contains(text(),'Choice1: Save Link')]",
        "save&add_link": "xpath=//a[contains(text(),'Choice2: Save/Add Link')]"
    }
}
...
classic_message_builder = {
    ...
    "button_add": {
        ...
        "message_reply_to_label": "name=messageReplyTo",
