...
Create_Landing_Page_Submit
    # Create Landing Page
    Wait Until Element is Visible    xpath=//*[@id="lpages-editor-columnid-1-0"]/div[1]/div/div/button[5]    timeout=50
    Sleep    2
    #------Email
    Click Element    xpath=//*[@id="lpages-editor-columnid-1-0"]/div[1]/div/div/button[5]
    Sleep    5
    ...
    Sleep    1
    Element Should Contain    id=lpages-notification-content    This page has been saved.    # Confirm 'Save'
...
Activate_Data_Synchronization
    ...
    Sleep    1
    Element Should Contain    xpath=//*[@id="lpages-notification-content"]/div[contains(text(),"Your modifications have been saved.")]    Your modifications have been saved.    # Check if saved
...
Test_Lending_Page
    ...
    Sleep    2
    Input Text    xpath=//*[@id="root"]/div/div/div/form/div[1]/div/div[3]/input    auto@smartfocus.com    # Input 'Email'
    Sleep    2
...
Verify_Lending_Page_And_Delete
    ...
    Sleep    3
    Input Text    name=textFieldValue    auto@smartfocus.com    # Search criteria
    Sleep    2
    ...
    Element Should Contain    xpath=//*[@id="rows"]/tr/td[contains(text(),"auto@smartfocus.com")]    auto@smartfocus.com    # Check 'Email'
