...
Login_Email
    ...
    ${present}=    Run Keyword And Return Status    Wait Until element Is Visible    xpath=//*[@id="SFUI_Nav"]/div/div/ul/li[3]/div    timeout=60
    ...
    ${present}=    Run Keyword And Return Status    Wait Until element Is Visible    xpath=//*[@id="SFUI_Nav"]/div/div/ul/li[4]/div    timeout=60
