...
request_list = [
    ...
    api.offer_click(settings.click, settings.guid, engagement, email=email, timestamp=one_day_past),
]
...
request_list = [
    api.login(settings.advisor, settings.username, settings.password, settings.aid, cookie_id=cookie_id_new,
              email=email),
    api.browse(settings.advisor, settings.username, settings.password, settings.aid, sku, cookie_id=cookie_id,
               cbtt=cbtt, timestamp=one_day_past),
    api.browse(settings.advisor, settings.username, settings.password, settings.aid, sku, cookie_id=cookie_id_new),
    api.cart_add(settings.advisor, settings.username, settings.password, settings.aid, sku, cookie_id=cookie_id_new),
    api.buy(settings.advisor, settings.username, settings.password, settings.aid, sku, cookie_id=cookie_id_new)
]
